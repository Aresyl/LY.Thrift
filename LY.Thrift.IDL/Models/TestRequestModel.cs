...
namespace LY.Thrift.IDL
{
  ...
  [Serializable]
  #endif
  public partial class TestRequestModel : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("TestRequestModel");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("TestRequestModel(");
      bool __first = true;
      if (__isset.isTrue) {
